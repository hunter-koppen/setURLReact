...
This widget in itself doesn't do much except visually change the url in your browser. If you want to actually have a working URL you should use this widget together the [Deeplink Module](https://marketplace.mendix.com/link/component/43) or use the newer [page url](https://docs.mendix.com/refguide/page-properties/#url) feature in Mendix studio pro.
